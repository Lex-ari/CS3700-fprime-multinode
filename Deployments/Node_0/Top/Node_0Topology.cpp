...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Node_0_blockDrv::WARN, PingEntries::Node_0_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Node_0_tlmSend::WARN, PingEntries::Node_0_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Node_0_cmdDisp::WARN, PingEntries::Node_0_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Node_0_cmdSeq::WARN, PingEntries::Node_0_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Node_0_eventLogger::WARN, PingEntries::Node_0_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Node_0_fileDownlink::WARN, PingEntries::Node_0_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Node_0_fileManager::WARN, PingEntries::Node_0_fileManager::FATAL, "fileManager"},
    {PingEntries::Node_0_fileUplink::WARN, PingEntries::Node_0_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Node_0_prmDb::WARN, PingEntries::Node_0_prmDb::FATAL, "prmDb"},
    {PingEntries::Node_0_rateGroup1::WARN, PingEntries::Node_0_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Node_0_rateGroup2::WARN, PingEntries::Node_0_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Node_0_rateGroup3::WARN, PingEntries::Node_0_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(Node_0PacketsPkts, Node_0PacketsIgnore, 1);
    ...
    hubComDriver.configure("0.0.0.0", 55000);
