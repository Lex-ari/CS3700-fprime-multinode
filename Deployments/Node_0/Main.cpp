...
#include <Deployments/Node_0/Top/Node_0Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Node_0::setupTopology(inputs);
    Node_0::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Node_0::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
