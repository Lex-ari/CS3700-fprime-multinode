...
int main(int argc, char* argv[]) {
    ...
    Node_1::setupTopology(inputs);
    Node_1::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Node_1::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
