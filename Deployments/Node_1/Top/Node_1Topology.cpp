// ======================================================================
// \title  Node_1Topology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Deployments/Node_1/Top/Node_1TopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Node_1/Top/Node_1PacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Node_1_blockDrv::WARN, PingEntries::Node_1_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Node_1_tlmSend::WARN, PingEntries::Node_1_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Node_1_cmdDisp::WARN, PingEntries::Node_1_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Node_1_cmdSeq::WARN, PingEntries::Node_1_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Node_1_eventLogger::WARN, PingEntries::Node_1_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Node_1_fileDownlink::WARN, PingEntries::Node_1_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Node_1_fileManager::WARN, PingEntries::Node_1_fileManager::FATAL, "fileManager"},
    {PingEntries::Node_1_fileUplink::WARN, PingEntries::Node_1_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Node_1_prmDb::WARN, PingEntries::Node_1_prmDb::FATAL, "prmDb"},
    {PingEntries::Node_1_rateGroup1::WARN, PingEntries::Node_1_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Node_1_rateGroup2::WARN, PingEntries::Node_1_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Node_1_rateGroup3::WARN, PingEntries::Node_1_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(Node_1PacketsPkts, Node_1PacketsIgnore, 1);
    ...
    hubComDriver.configure("0.0.0.0", 55010);
    Os::TaskString hubName("hub");
    hubComDriver.start(hubName, COMM_PRIORITY, Default::STACK_SIZE);
}

// Public functions for use in main program are namespaced with deployment name Node_1
namespace Node_1 {
