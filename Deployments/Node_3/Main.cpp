...
#include <Node_3/Top/Node_3Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Node_3::setupTopology(inputs);
    Node_3::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Node_3::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
