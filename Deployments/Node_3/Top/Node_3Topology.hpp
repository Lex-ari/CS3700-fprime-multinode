// ======================================================================
// \title  Node_3Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NODE_3_NODE_3TOPOLOGY_HPP
#define NODE_3_NODE_3TOPOLOGY_HPP
// Included for access to Node_3::TopologyState and Node_3::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Node_3/Top/Node_3TopologyDefs.hpp>

// Remove unnecessary Node_3:: qualifications
 ...
 * Node_3::TopologyState see: Node_3TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Node_3::TopologyState see: Node_3TopologyDefs.hpp.
 *
