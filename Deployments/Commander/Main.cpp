...
#include <Deployments/Commander/Top/CommanderTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Commander::TopologyState inputs;
    ...
    Commander::setupTopology(inputs);
    Commander::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Commander::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
