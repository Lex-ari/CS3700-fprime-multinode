 ...
 * Commander::TopologyState see: CommanderTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Commander::TopologyState see: CommanderTopologyDefs.hpp.
 *
