...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Commander_blockDrv::WARN, PingEntries::Commander_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Commander_tlmSend::WARN, PingEntries::Commander_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Commander_cmdDisp::WARN, PingEntries::Commander_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Commander_cmdSeq::WARN, PingEntries::Commander_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Commander_eventLogger::WARN, PingEntries::Commander_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Commander_fileDownlink::WARN, PingEntries::Commander_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Commander_fileManager::WARN, PingEntries::Commander_fileManager::FATAL, "fileManager"},
    {PingEntries::Commander_fileUplink::WARN, PingEntries::Commander_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Commander_prmDb::WARN, PingEntries::Commander_prmDb::FATAL, "prmDb"},
    {PingEntries::Commander_rateGroup1::WARN, PingEntries::Commander_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Commander_rateGroup2::WARN, PingEntries::Commander_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Commander_rateGroup3::WARN, PingEntries::Commander_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(CommanderPacketsPkts, CommanderPacketsIgnore, 1);
