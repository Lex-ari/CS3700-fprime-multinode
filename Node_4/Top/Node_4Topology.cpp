// ======================================================================
// \title  Node_4Topology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Node_4/Top/Node_4TopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Node_4/Top/Node_4PacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Node_4_blockDrv::WARN, PingEntries::Node_4_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Node_4_tlmSend::WARN, PingEntries::Node_4_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Node_4_cmdDisp::WARN, PingEntries::Node_4_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Node_4_cmdSeq::WARN, PingEntries::Node_4_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Node_4_eventLogger::WARN, PingEntries::Node_4_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Node_4_fileDownlink::WARN, PingEntries::Node_4_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Node_4_fileManager::WARN, PingEntries::Node_4_fileManager::FATAL, "fileManager"},
    {PingEntries::Node_4_fileUplink::WARN, PingEntries::Node_4_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Node_4_prmDb::WARN, PingEntries::Node_4_prmDb::FATAL, "prmDb"},
    {PingEntries::Node_4_rateGroup1::WARN, PingEntries::Node_4_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Node_4_rateGroup2::WARN, PingEntries::Node_4_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Node_4_rateGroup3::WARN, PingEntries::Node_4_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(Node_4PacketsPkts, Node_4PacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Node_4
namespace Node_4 {
